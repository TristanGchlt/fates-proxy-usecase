...
![CI Schema](img/readme_schema_2.png "WIP CI Pipeline Schema")
...
![Fairness Schema](img/readme_schema_3.png "WIP Fairness Pipeline Schema")
...
![Transparency Schema](img/readme_schema_4.png "WIP Transparency Pipeline Schema")
